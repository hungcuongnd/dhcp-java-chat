...
public class FormChoose extends javax.swing.JFrame {
     ...
     */    
    public FormChoose(JFrame jFrame, ArrayList<String> listText, Callable confirmFunction, Callable cancelFunction) {
        initComponents();
        ...
        this.btnCancel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(FormChoose.class.getName()).log(Level.SEVERE, null, ex);
                }
                hideFormConfirm();
            }
        });
